...
const base = {
  colors: {
    brightYellow: '#cfe8e7',        // Soft warning yellow
    brightMint: '#4ec9b0',          // Mint/teal (functions/constants)
    lowerMint: '#3aa995',           // Darker mint
    blueishGreen: '#2e8b85',        // Desaturated teal

    lowerBlue: '#70899e',           // React docs soft blue
    lightBlue: '#a7cdd9',           // Subtle cyan (parameters)
    desaturatedBlue: '#7da5b3',     // Light sky blue
    bluishGrayBrighter: '#dcf8fc',  // Light gray-blue

    hotRed: '#ed537a',              // Soft error red
    pink: '#b6d1cd',                // Keyword purple (React docs)
    gray: '#cfdee6',                // Main text gray

    darkerGray: '#808080',          // Darker gray for dim text
    bluishGray: '#5a5a5a',          // Neutral gray
    focus: '#2a2a2a',               // Hover/focus background
    bg: '#1a1a1a',                  // Main editor background (React docs)

    offWhite: '#f3f3f3',            // Very soft white
    selection: '#264f7840',         // Subtle selection blue overlay
...
const storm = {
  ...
  colors: {
    ...
    bluishGray: '#707070',
    focus: '#333333',
    bg: '#202020',                  // Storm = slightly brighter background
    selection: '#33557740',
    black: '#101010',
  },
}
...
function schema({ colors, styles }) {
  return `{
    ...
    "tokenColors": [
      ...
      {
        "scope": ["keyword.operator.existential"],
        "settings": {
          "foreground": "${colors.gray}"
        }
      },
